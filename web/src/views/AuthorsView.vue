        ...
        <div class="position-relative">
            ...
            <table class="table table-dark table-striped table-hover">
                ...
                <tbody>
                    ...
                    <tr v-if="adding">
                        ...
                        <td>
                            <div class="input-group input-group-sm">
                                ...
                                <button class="btn btn-outline-secondary" type="button" @click="openHardcoverModal">
                    ...
                    <!-- Author rows -->
                    <AuthorRow v-for="author in authors" :key="author.id" :author="author"
                        :is-editing="editingId === author.id" :subscription-scopes="subscriptionScopes"
                        :notifiers="notifiers" @edit="startEdit(author.id)"
                        @save="(data) => saveEdit(author.id, data)" @cancel="cancelEdit"
