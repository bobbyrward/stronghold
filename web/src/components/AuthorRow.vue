...
<template>
    ...
    <tr @click="toggleExpand" :style="{ cursor: isEditing ? 'default' : 'pointer' }">
        ...
        <td>{{ author.id }}</td>
        <td>
            <input v-if="isEditing" type="text" v-model="editData.name" class="form-control form-control-sm"
                @click.stop>
        ...
        <td>
            <template v-if="isEditing">
                <div class="input-group input-group-sm" @click.stop>
                    ...
                    <button class="btn btn-outline-secondary" type="button" @click="showHardcoverModal = true">
        ...
        <td colspan="5">
            <div class="ps-4 py-2">
                <ul class="nav nav-tabs">
                    ...
                    <li class="nav-item">
                        <button class="nav-link" :class="{ active: activeTab === 'downloads' }"
                ...
                <div class="tab-content p-3 border border-top-0 rounded-bottom">
                        ...
                        <div class="row mb-3">
                            <div class="col">
                                <div class="input-group input-group-sm">
                                    <input type="text" v-model="newAliasName" class="form-control"
                                        placeholder="New alias name..." @keyup.enter="addAlias">
                                    ...
                                    <td>
                                        <template v-if="editingAliasId === alias.id">
                                            <button class="btn btn-success btn-sm me-1"
                                                @click="saveEditAlias(alias.id)" title="Save">
                                                <i class="bi bi-check"></i>
                                            </button>
                                            <button class="btn btn-secondary btn-sm" @click="cancelEditAlias"
                                                title="Cancel">
                                                <i class="bi bi-x"></i>
                                            </button>
                                        </template>
                                        <template v-else>
                                            <button class="btn btn-primary btn-sm me-1" @click="startEditAlias(alias)"
                                                title="Edit">
                                                <i class="bi bi-pencil"></i>
                                            </button>
                                            <button class="btn btn-danger btn-sm" @click="confirmDeleteAlias(alias)"
                                                title="Delete">
                                                <i class="bi bi-trash"></i>
                                            </button>
                                        </template>
                    ...
                    <div v-else-if="activeTab === 'downloads'" class="tab-pane active">
                        ...
                        <div v-else>
                            ...
                            <router-link :to="`/subscription-items?author_id=${author.id}`"
    ...
    <HardcoverSearchModal :show="showHardcoverModal" @close="showHardcoverModal = false"
        @select="handleHardcoverSelect" />
